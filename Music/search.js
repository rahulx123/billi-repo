...
async execute(message,args,client) {
    ...
    .setAuthor("Searching...", "https://thumbs.gfycat.com/PerfumedAdorableAkitainu-max-1mb.gif")
    .setColor("#F0EAD6")
    ...
    let resultsEmbed = new MessageEmbed()
      ...
      .setColor("#F0EAD6")
      .setAuthor("Search results!!", "https://thumbs.gfycat.com/PerfumedAdorableAkitainu-max-1mb.gif","http://Billimusic.tk")
      .setFooter("Response with your favorite number","https://thumbs.gfycat.com/PerfumedAdorableAkitainu-max-1mb.gif")
