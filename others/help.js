...
module.exports = {
  ...
  execute(message,args,client) {
    ...
    let helpEmbed = new MessageEmbed()
      .setTitle("Billi Help")
      .setAuthor('Click here to invite me!!', 'https://thumbs.gfycat.com/PerfumedAdorableAkitainu-max-1mb.gif', 'https://discord.com/api/oauth2/authorize?client_id=767885987740254291&permissions=49572160&scope=bot')
      .setDescription(`**PREFIX:** \`${PREFIX}\``)
      .setFooter( client.user.username +`Type: ${PREFIX}help <Command>  for more information!`, "https://thumbs.gfycat.com/PerfumedAdorableAkitainu-max-1mb.gif")
      .setColor("#F0EAD6");
